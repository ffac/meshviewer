define(["moment", "numeral", "tablesort", "c3", "tablesort.numeric"],
  function (moment, numeral, Tablesort, c3) {
  ...
  function showChart(chartConfig, d) {
        ...
        if (d.results && d.results[0] && d.results[0].series && d.results[0].series[0])
          d.results[0].series[0].values.forEach(function(vs) {
            ...
            vs.forEach(function(v, k) {
              tmp[d.results[0].series[0].columns[k]] = (v == null ? 0 : v)
            })
            data.push(tmp)
          })
        return data
    ...
    var drawChart = function(data) {
      ...
      if (!chartConfig.c3.data || !chartConfig.c3.data.json) {
        if (!chartConfig.c3.data) chartConfig.c3.data = {}
